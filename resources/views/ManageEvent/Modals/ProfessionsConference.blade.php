        ...
        <div class="modal-content">
            <div class="modal-header text-center">
                ...
                <h3 class="modal-title">
                    Show Professions for : {{ $conference->name }}
                </h3>
            </div>
                    ...
                    <div class="col-md-12">
                                                 ...
                                                 class="conference-link">
                                                    <div class="card h-100 shadow-sm hover-shadow">
                                                        <div class="card-body">
                                                            ...
                                                            <h4 class="card-title text-center">{{ $profession->name }}</h4>
                                                        </div>
                                                    </div>
                                                </a>
                                            </div>
                        ...
                        @else
                            <div class="alert alert-info">
                                <p class="mb-0 text-center">No professions found for this conference.</p>
                            </div>
                        @endif
                    </div>
                </div>
